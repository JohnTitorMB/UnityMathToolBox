...
# Parametric Intersection between Segment and various shapes

- [Segment - Plan](#Segment---Plan (P))
- [Segment - PlanXZ](#Segment---PlanXZ (P))
- [Segment - Quad](#Segment---Quad-(P))
- [Segment - CircularPlan](#Segment---CircularPlan-(P))
- [Segment - Sphere](#Segment---Sphere-(P))
- [Segment - Cylinder without caps](#Segment---Cylinder-without-caps-(P))
- [Segment - Sphere Up Caps](#Segment---Sphere-Up-Caps-(P))
- [Segment - Capsule](#Segment---Capsule-(P))
- [Segment - Minkowski Box Sphere](#Segment---Minkowski-Box-Sphere-(P))
...
```c#
    float t = 0.0f;
    if(ParametricCollisionUtility.CheckSegmentPlanIntersection(new Vector3(0,6,0), new Vector3(0,-2,0), new Vector3(0,-1,0), new Vector3(0,1,0), ref t))
        Debug.Log("t : " + t);
```
...
### Definition :
```c#
    public static bool CheckSegmentPlanXZIntersection(Vector3 _segmentAPointA, Vector3 _segmentAPointB, ref float _t)
```

### Example : 
```c#
    float t = 0.0f;
    if(ParametricCollisionUtility.CheckSegmentPlanXZIntersection(new Vector3(0,6,0), new Vector3(0,-2,0), ref t))
        Debug.Log("t : " + t);
```
...
### Definition :
```c#
    public static bool CheckSegmentQuadIntersection(Vector3 _segmentAPointA, Vector3 _segmentAPointB, Vector3 quadPointA, Vector3 quadPointB, Vector3 quadPointC, ref float _t)
```

### Example : 
```c#
    float t = 0.0f;
    if(ParametricCollisionUtility.CheckSegmentQuadIntersection(new Vector3(0,-6,0), new Vector3(0,5,0), new Vector3(-0.5f, 0, -0.5f), new Vector3(0.5f, 0, -0.5f), new Vector3(-0.5f,0,0.5f), ref t))
        Debug.Log("t : " + t);
```

## Segment - CircularPlan (P)
...
```c#
    float t = 0.0f;
    if(ParametricCollisionUtility.CheckSegmentCircleIntersection(new Vector3(0,-6,0), new Vector3(0,5,0), new Vector3(0.0f, 2.0f, 0.0f), new Vector3(0, 1, 0), ref t))
        Debug.Log("t : " + t);
```
...
```c#
    float t0 = 0.0f;
    float t1 = 0.0f;
    if(ParametricCollisionUtility.CheckSegmentSphereIntersection(new Vector3(0,-6,0), new Vector3(0,5,0), new Vector3(0.0f, 2.0f, 0.0f), 0.5f, ref t0, ref t1))
    {
        Debug.Log("t0 : " + t0);
        Debug.Log("t1 : " + t1);
    }
...
## Segment - Cylinder without caps (P)
...
```c#
    float t0 = 0.0f;
    float t1 = 0.0f;
    if(ParametricCollisionUtility.CheckSegmentCylinderWihtoutCapsIntersection(new Vector3(-6,0,0), new Vector3(5,0,0), new Vector3(0,0,0), new Vector3(0,1,0), 0.5f, 2.0f, ref t0, ref t1))
    {
        Debug.Log("t0 : " + t0);
        Debug.Log("t1 : " + t1);
    }
...
```c#
    float t0 = 0.0f;
    float t1 = 0.0f;
    if(ParametricCollisionUtility.CheckSegmentSphereCapsIntersection(new Vector3(-3,0,0), new Vector3(5,0,0), new Vector3(0,-0.2,0), new Vector3(0,1,0), 0.5f, ref t0, ref t1))
    {
        Debug.Log("t0 : " + t0);
        Debug.Log("t1 : " + t1);
    }
...
```c#
    float t0 = 0.0f;
    float t1 = 0.0f;
    if(ParametricCollisionUtility.CheckSegmentCapsuleIntersection(new Vector3(-3,0,0), new Vector3(5,0,0), new Vector3(0,0,0), new Vector3(0,1,0), 0.5f, 2.0f, ref t0, ref t1))
    {
        Debug.Log("t0 : " + t0);
        Debug.Log("t1 : " + t1);
    }
...
## Segment - Minkowski Box Sphere (P)
...
```c#
    float t0 = 0.0f;
    float t1 = 0.0f;
    if(ParametricCollisionUtility.CheckSegmentMinkowskiBoxSphereIntersection(new Vector3(-3,0,0), new Vector3(5,0,0), new Vector3(0,0,0), Quaternion.identity, 0.2f, ref t0, ref t1))
    {
        Debug.Log("t0 : " + t0);
        Debug.Log("t1 : " + t1);
    }
